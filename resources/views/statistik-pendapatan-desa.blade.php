...
@section('title', 'Pendapatan Desa - Ekonomi | Desa Cantik')
                ...
                <table class="w-full text-xs" id="tabel-pendapatan">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $row['stripe'] ? 'bg-gray-50/60' : 'bg-white' }} border-t border-gray-100 {{ isset($row['isTotal']) ? 'font-bold bg-gray-50/80' : '' }}">
                            ...
                            <td class="px-6 py-3 text-gray-700">{{ $row['y22'] }}</td>
                            <td class="px-6 py-3 text-gray-700">{{ $row['y23'] }}</td>
                            <td class="px-6 py-3 text-gray-700 font-semibold">{{ $row['y24'] }}</td>
                            <td class="px-6 py-3">
                                <span class="text-green-600 font-semibold">{{ $row['pct'] }}</span>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
