...
@section('title', 'Pertumbuhan Penduduk - Kependudukan | Desa Cantik')
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $row['stripe'] ? 'bg-gray-50/60' : 'bg-white' }} border-t border-gray-100">
                            ...
                            <td class="px-6 py-3">
                                ...
                                @else
                                    <span class="text-green-600 font-semibold">{{ $row['tumbuh'] }}</span>
                                @endif
                            </td>
                            <td class="px-6 py-3">
                                @if($row['laju'] === '-')
                                    <span class="text-gray-400">—</span>
                                @else
                                    <span class="text-green-600 font-semibold">{{ $row['laju'] }}</span>
                                @endif
                            </td>
                        </tr>
                        @endforeach
