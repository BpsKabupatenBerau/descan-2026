...
@section('title', 'Data UMKM - Ekonomi | Desa Cantik')
                        ...
                        <tr class="{{ $row['stripe'] ? 'bg-gray-50/60' : 'bg-white' }} border-t border-gray-100">
                            <td class="px-6 py-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-900 font-medium">{{ $row['sector'] }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-3 text-gray-700">{{ $row['jumlah'] }}</td>
                            <td class="px-6 py-3 text-gray-700">{{ $row['pekerja'] }}</td>
                            <td class="px-6 py-3 text-gray-700">{{ $row['omzet'] }}</td>
                            <td class="px-6 py-3 text-gray-700">
                                @if($row['keterangan'] === '—')
                                    <span class="text-gray-400">—</span>
                                @elseif($row['keterangan'] === 'Terbesar')
                                ...
                                @elseif($row['keterangan'] === 'Ekspor lokal')
