<?php $__env->startSection('title', 'Fasilitas Pendidikan - Sarana & Prasarana | Desa Cantik'); ?>
...
<div class="flex min-h-screen bg-stone-50">
    ...
    <aside class="w-60 flex-shrink-0 bg-white border-r border-gray-200 pt-4 pb-8">
        ...
        <nav>
            <?php $__currentLoopData = $saranaItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <table class="w-full text-xs" id="tabel-pendidikan">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo e($row['stripe'] ? 'bg-gray-50/60' : 'bg-white'); ?> border-t border-gray-100">
                            ...
                            <td class="px-6 py-3 text-gray-700"><?php echo e($row['siswa']); ?> Jiwa</td>
                            <td class="px-6 py-3 text-gray-700"><?php echo e($row['guru']); ?> Orang</td>
                            <td class="px-6 py-3">
                                <?php if($row['akreditasi'] === '—'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel\Herd Laravel\desacantikberau\resources\views/statistik-fasilitas-pendidikan.blade.php ENDPATH**/ ?>