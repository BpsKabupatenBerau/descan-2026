<?php $__env->startSection('title', 'Mata Pencaharian - Ekonomi | Desa Cantik'); ?>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo e($row['stripe'] ? 'bg-gray-50/60' : 'bg-white'); ?> border-t border-gray-100">
                            ...
                            <td class="px-6 py-3 text-gray-700">
                                <?php if($row['l'] === '—'): ?> <span class="text-gray-400">—</span> <?php else: ?> <?php echo e($row['l']); ?> <?php endif; ?>
                            </td>
                            <td class="px-6 py-3 text-gray-700">
                                <?php if($row['p'] === '—'): ?> <span class="text-gray-400">—</span> <?php else: ?> <?php echo e($row['p']); ?> <?php endif; ?>
                            </td>
                            <td class="px-6 py-3 text-gray-700 font-semibold"><?php echo e($row['total']); ?></td>
                            <td class="px-6 py-3 text-gray-500"><?php echo e($row['pct']); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel\Herd Laravel\desacantikberau\resources\views/statistik-mata-pencaharian.blade.php ENDPATH**/ ?>