<?php $__env->startSection('title', 'Usia Produktif - Kependudukan | Desa Cantik'); ?>
                ...
                <table class="w-full text-xs" id="tabel-usia">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo e($row['stripe'] ? 'bg-gray-50/60' : 'bg-white'); ?> border-t border-gray-100">
                            <td class="px-6 py-3 text-gray-900 font-medium"><?php echo e($row['usia']); ?></td>
                            ...
                            <td class="px-6 py-3">
                                <span class="px-2 py-0.5 rounded-full text-[10px] font-semibold <?php echo e($row['katColor']); ?>">
                                    <?php echo e($row['kat']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel\Herd Laravel\desacantikberau\resources\views/statistik-usia-produktif.blade.php ENDPATH**/ ?>