<?php $__env->startSection('title', 'Sarana Ibadah - Sarana & Prasarana | Desa Cantik'); ?>
                ...
                <table class="w-full text-xs" id="tabel-ibadah">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo e($row['stripe'] ? 'bg-gray-50/60' : 'bg-white'); ?> border-t border-gray-100 <?php echo e(isset($row['isTotal']) ? 'font-bold bg-gray-50/80' : ''); ?>">
                            ...
                            <td class="px-6 py-3 text-gray-700"><?php echo e($row['kapasitas']); ?></td>
                            <td class="px-6 py-3">
                                <?php if($row['kondisi'] === '—'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel\Herd Laravel\desacantikberau\resources\views/statistik-sarana-ibadah.blade.php ENDPATH**/ ?>