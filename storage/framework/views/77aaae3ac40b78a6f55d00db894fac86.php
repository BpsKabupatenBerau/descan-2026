<?php $__env->startSection('title', 'Fasilitas Kesehatan - Sarana & Prasarana | Desa Cantik'); ?>
                ...
                <table class="w-full text-xs" id="tabel-kesehatan">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo e($row['stripe'] ? 'bg-gray-50/60' : 'bg-white'); ?> border-t border-gray-100">
                            ...
                            <td class="px-6 py-3 text-gray-700"><?php echo e($row['lokasi']); ?></td>
                            <td class="px-6 py-3">
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-green-50 text-green-700 border border-green-200">
                                    <?php echo e($row['kondisi']); ?>

                                </span>
                            </td>
                            <td class="px-6 py-3 text-gray-700"><?php echo e($row['keterangan']); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel\Herd Laravel\desacantikberau\resources\views/statistik-fasilitas-kesehatan.blade.php ENDPATH**/ ?>